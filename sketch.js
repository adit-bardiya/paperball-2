var dustbin2,dustbin3,paperball,sceneState,i;
...
function setup() {
	...
	dustbin2 = new Dustbin(560,600,20,170);
	dustbin3 = new Dustbin(740,600,20,170);
...
function draw() {
  ...
  fill("black");
  textSize(30);
  text("throw the paper into the dustbin using the up arrow key",0,120);
  text ("right arrow to continue left arrow to go back",0,180);
...
function keyPressed(){
	if(keyDown(UP_ARROW)&&i===1){
		Matter.Body.applyForce(paperball.body,paperball.body.position,{x:8,y:-11.6});
		i = 2;
	}
}
